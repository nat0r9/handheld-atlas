    ...
    <main className="atlas-page pb-14 text-white">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">
                ...
                Atlas Scores and recommended
                handheld settings backed by
                live database data.
              </p>
            </div>
      ...
      <div className="atlas-shell pt-6">
        ...
        <section className="atlas-panel p-4 md:p-5">
          <div className="grid gap-4 xl:grid-cols-[1.7fr_repeat(5,minmax(0,1fr))_auto]">
            <div>
              <FilterLabel
                htmlFor="game-search"
                label="Search"
                ...
                (game) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group"
                    >
                      <article className="atlas-card atlas-card-hover flex h-full flex-col">
                        <div className="relative aspect-[4/5] overflow-hidden">
                          ...
                          <div className="absolute right-3 top-3">
                            <div
                              className={`flex h-14 w-14 flex-col items-center justify-center rounded-xl border backdrop-blur ${rating.scoreClassName}`}
                            >
                              <span className="text-[0.45rem] font-black uppercase tracking-[0.1em]">
                                Atlas
                              </span>

                              <strong className="mt-0.5 text-xl leading-none">
                                {game.atlasScore ??
                                  "—"}
                              </strong>
                            </div>
                          ...
                          <div className="absolute inset-x-0 bottom-0 p-4">
                            ...
                            <h3 className="mt-1.5 line-clamp-2 text-2xl font-black leading-[1.05]">
                              {game.name}
                            </h3>
                        ...
                        <div className="flex flex-1 flex-col p-4">
                          <div>
                            <div className="flex items-center justify-between text-[0.62rem] font-black uppercase tracking-[0.12em] text-slate-600">
                              <span>
                                Compatibility
                              </span>
